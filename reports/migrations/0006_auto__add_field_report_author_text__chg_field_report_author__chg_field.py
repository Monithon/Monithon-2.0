...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.author_text'
        db.add_column(u'reports_report', 'author_text',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Report.author'
        db.alter_column(u'reports_report', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['monitor.MonitoringTeam']))

        # Changing field 'Report.datetime'
        db.alter_column(u'reports_report', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'Report.author_text'
        db.delete_column(u'reports_report', 'author_text')


        # Changing field 'Report.author'
        db.alter_column(u'reports_report', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['monitor.MonitoringTeam']))

        # Changing field 'Report.datetime'
        db.alter_column(u'reports_report', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
