...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.position'
        db.add_column(u'reports_report', 'position',
                      self.gf('django.contrib.gis.db.models.fields.GeometryField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.position'
        db.delete_column(u'reports_report', 'position')
    ...
    models = {
        ...
        u'reports.report': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'position': ('django.contrib.gis.db.models.fields.GeometryField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'reports.reportlink': {
            ...
            'report': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'links'", 'to': u"orm['reports.Report']"})
        }
    }
