...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReportLink.link'
        db.alter_column(u'reports_reportlink', 'link', self.gf('django.db.models.fields.URLField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'ReportLink.link'
        db.alter_column(u'reports_reportlink', 'link', self.gf('django.db.models.fields.URLField')(max_length=200))
