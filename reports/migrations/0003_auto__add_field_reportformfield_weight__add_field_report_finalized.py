...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportFormField.weight'
        db.add_column(u'reports_reportformfield', 'weight',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)

        # Adding field 'Report.finalized'
        db.add_column(u'reports_report', 'finalized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportFormField.weight'
        db.delete_column(u'reports_reportformfield', 'weight')

        # Deleting field 'Report.finalized'
        db.delete_column(u'reports_report', 'finalized')
    ...
    models = {
        ...
        u'reports.reportformfield': {
            'Meta': {'ordering': "['weight']", 'object_name': 'ReportFormField'},
