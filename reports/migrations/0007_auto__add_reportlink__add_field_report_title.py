...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'reports_reportlink')

        # Deleting field 'Report.title'
        db.delete_column(u'reports_report', 'title')
