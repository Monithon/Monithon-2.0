...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MonitorableCategory'
        db.create_table(u'projects_monitorablecategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('icon', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'projects', ['MonitorableCategory'])

        # Adding field 'Monitorable.category'
        db.add_column(u'projects_monitorable', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.MonitorableCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MonitorableCategory'
        db.delete_table(u'projects_monitorablecategory')

        # Deleting field 'Monitorable.category'
        db.delete_column(u'projects_monitorable', 'category_id')
